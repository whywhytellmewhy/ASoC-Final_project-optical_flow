; ModuleID = '/home/ubuntu/SoC_Design/homework/ASoC_lab4_FSIC_FPGA/vivado/vitis_prj/userdma_fir/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a64struct.ap_int<32>.38"([64 x i32]* align 512 %4, [64 x %"struct.ap_int<32>"]* %3)
  call fastcc void @onebyonecpy_hls.p0i1(i1* align 512 %6, i1* %5)
  call fastcc void @"onebyonecpy_hls.p0a64struct.ap_int<32>.38"([64 x i32]* align 512 %8, [64 x %"struct.ap_int<32>"]* %7)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a64struct.ap_int<32>.38"([64 x i32]* noalias align 512, [64 x %"struct.ap_int<32>"]* noalias readonly) unnamed_addr #2 {
entry:
