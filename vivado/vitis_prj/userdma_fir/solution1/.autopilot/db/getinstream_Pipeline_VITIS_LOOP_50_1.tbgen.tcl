...
set C_modelArgList {
	...
	{ tmp_user_V_out int 3 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_len_V_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_user_V_out", "interface" : "wire", "bitwidth" : 3, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ incount40_num_data_valid sc_in sc_lv 7 signal 8 } 
	{ incount40_fifo_cap sc_in sc_lv 7 signal 8 } 
	...
	{ tmp_user_V_out sc_out sc_lv 3 signal 9 } 
	{ tmp_user_V_out_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_user_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "tmp_user_V_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_user_V_out { ap_vld {  { tmp_user_V_out out_data 1 3 }  { tmp_user_V_out_ap_vld out_vld 1 1 } } }
}
