...
set portList { 
	...
	{ incount40_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ incount40_fifo_cap sc_in sc_lv 7 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "incount40", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	incount40 { ap_fifo {  { incount40_dout fifo_port_we 0 32 }  { incount40_num_data_valid fifo_status_num_data_valid 0 7 }  { incount40_fifo_cap fifo_update 0 7 }  { incount40_empty_n fifo_status 0 1 }  { incount40_read fifo_data 1 1 } } }
